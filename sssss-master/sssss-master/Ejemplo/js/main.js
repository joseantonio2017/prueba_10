...
function creaNuevaDB(tx){
	...
	tx.executeSql("INSERT INTO agenda_curso (id,nombre,apellidos,telefono,categoria,foto,email) VALUES (1,'Antonio','Ortiz','+6691118779','amigo','','capilla_ball@hotmail.com')");
}
